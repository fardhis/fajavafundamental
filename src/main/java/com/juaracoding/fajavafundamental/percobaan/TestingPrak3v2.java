...
Java Developer
Created on 7/7/2023 9:42 AM
@Last Modified 7/7/2023 9:42 AM
Version 1.0
*/
...
//        Rata-rata:  55.4
    ...
    public static Double rataRata(ArrayList arrayInput){
        ...
        {
            int intCounter = (int) arrayInput.get(i);
            intTampung = intTampung + intCounter;
        }
